...
The application is now running. Select your persona to get started:

| Persona | Intended For | Guide |
|---|---|---|
| Curriculum Builder | Faculty | [View guide](../guides/user-guides/curriculum-builder.md) |
| Expert Advisor | Lecturers | [View guide](../guides/user-guides/expert-advisor.md) |
| Learning Companion | Students | [View guide](../guides/user-guides/learning-companion.md) |
