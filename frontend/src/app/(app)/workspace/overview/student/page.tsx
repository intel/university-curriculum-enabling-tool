...
import { Clock, Plus, Tag, BookOpen, HardDriveDownload, Tags } from 'lucide-react'
      ...
      <div className="container mx-auto max-w-7xl p-6">
        <div className="flex h-[calc(100vh-200px)] flex-col items-center justify-center text-center">
          ...
          <p className="mb-6 max-w-xs text-sm text-muted-foreground">
            You have not add any courses yet. Add courses to start learning.
          </p>
          <Button
              ...
              <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
                    ...
                    <>
                      <Card className="border-primary/20 shadow-sm">
                        ...
                        <CardFooter className="flex justify-between border-t pt-4">
                          <Button
                            variant="outline"
                            onClick={() => router.push('/workspace/quiz/practice')}
                          >
                            Start Learning
                          </Button>
                          <Button onClick={() => router.push(`/workspace/chat`)}>New Chat</Button>
                        </CardFooter>
                      </Card>
                      ...
                      <div>
                        ...
                        <div className="space-y-3">
                          {[1, 2, 3].map((i) => (
                            <Card key={i} className="cursor-default opacity-70">
                ...
                <div className="space-y-6">
                  ...
                  {relatedCourses && relatedCourses.length > 0 && (
                    <>
                      <h2 className="mt-8 text-lg font-bold">Related Courses</h2>
                      <div className="space-y-3">
